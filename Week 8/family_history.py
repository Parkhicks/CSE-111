...
def print_death_age(people_dict):
    ...
    for people in people_dict:
        ...
        age = person[3]-person[2]
        birth= person[2]
        death= person[3]
        print(str(person[0]) + " was born in "+str(birth) + " and died in " + str(death) +" at the age of: " + str(age))
    pass
...
def count_genders(people_dict):
    ...
    for people in people_dict:
        person = people_dict[people]
        if person[1] == "F":
            females.append(people[0])
        elif person[1] =="M":
            males.append(people[0])
    
    print ("There are: " + str(len(males)) +" Males")
    print ("There are: " + str(len(females)) +" Females")
    pass
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriages in marriages_dict:
        ...
        person_one = marriage[0]
        person_two = marriage[1]
        year = marriage[2]
        pers_one =people_dict[person_one]
        pers_two = people_dict[person_two]
        name_one = pers_one[0]
        name_two = pers_two[0]
        age_one = year-pers_one[2]
        age_two = year-pers_two[2]
        print("The Husband was " + str(name_one) + " who was " + str(age_one) + " when he married " + str(name_two) + " who was " + str(age_two) + " when they got married in " + str(year))
    pass
