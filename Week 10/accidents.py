...
def main():
    ...
    try:
        ...
        print()
        print("The inputed value isn't an acceptable number.")
        print("Run the program again and enter a number between" \
                " 0-100.")
    except IndexError:
        print("")
        print("The entered number is not in the acceptable range. Please run the program again and input a number between 0-100")
